...
# 拡張子
NIME_STILL_SUFFIX = ".jpg"
NIME_VIDEO_SUFFIX = ".gif"
NIME_CONTENT_SUFFIXES = [NIME_STILL_SUFFIX, NIME_VIDEO_SUFFIX]
RAW_STILL_SUFFIX = ".png"
RAW_VIDEO_SUFFIX = ".zip"
RAW_CONTENT_SUFFIXES = [RAW_STILL_SUFFIX, RAW_VIDEO_SUFFIX]
ALL_STILL_SUFFIXES = [NIME_STILL_SUFFIX, RAW_STILL_SUFFIX]
ALL_VIDEO_SUFFIXES = [NIME_VIDEO_SUFFIX, RAW_VIDEO_SUFFIX]
ALL_CONTENT_SUFFIXES = NIME_CONTENT_SUFFIXES + RAW_CONTENT_SUFFIXES
